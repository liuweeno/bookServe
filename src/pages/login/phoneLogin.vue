  ...
  <view class="main-container">
    ...
    <view class="control-container">
      <view class="login-way">
        <text :class="wayChoose === 'code-login' ? 'checked-way' : null" @click="clickChangeWay('code-login')"
          >快捷登录</text
        >
        <text :class="wayChoose === 'pw-login' ? 'checked-way' : null" @click="clickChangeWay('pw-login')"
          >密码登录</text
        >
      </view>
      <up-input
