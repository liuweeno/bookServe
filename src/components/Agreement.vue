...
const bottomPopupShow = ref<boolean>(false);
const agreementType = ref<number>(0);
...
function showPopup(agree: number) {
  agreementType.value = agree;
  bottomPopupShow.value = true;
}
</script>

<template>
  <view class="choose-container">
    <view class="check-box" @click="onCheckAgreement">
      <image v-if="checked === false" src="@/assets/img/login/no-check.png" />
      <image v-else src="@/assets/img/login/is-check.png" />
    </view>
    <view class="check-content">
      <span @click="onCheckAgreement">我已阅读并同意</span
      ><span class="agreement-font" @click="showPopup(0)">《用户协议》</span>和<span
        class="agreement-font"
        @click="showPopup(1)"
        >《隐私政策》</span
      >
    </view>
  ...
  <u-popup :show="bottomPopupShow" :round="10" mode="bottom" customStyle="height: 696rpx" :closeOnClickOverlay="true">
    <view class="agreement-content">
      <view class="agreement-title">
        <div class="arrow"><u-icon name="arrow-left" @click="closeAgreement" /></div>
        <view>{{ agreementType === 0 ? '用户协议' : '隐私政策' }}</view>
      </view>
      <scroll-view class="agreement-context" scroll-y="{{true}}" show-scrollbar="{{false}}" v-if="agreementType === 0">
        <view class="myOne">
          <view class="my-div">
            <view>
              一、总则
      ...
      <scroll-view class="agreement-context" scroll-y="{{true}}" show-scrollbar="{{false}}" v-else>
        <view class="myOne">
          <view class="my-div">
            <view>
            ...
            <view>
              ...
              <view>
                3. 信息披露
                <view>
                  在如下情况下，本应用将依据您的个人意愿或法律的规定全部或部分的披露您的个人信息： (a)
                  未经您事先同意，我们不会向第三方披露。 (b)
